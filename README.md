...
>
> 感谢理解！问题反馈：[Issues](https://github.com/chuanyedefeng/NewPush666/issues)
>
> </details>


<div align="center" id="newpush666">

<a href="https://github.com/chuanyedefeng/NewPush666" title="NewPush666">
  <img src="/_image/banner.webp" alt="NewPush666 Banner" width="80%">
</a>
...
[![GitHub Stars](https://img.shields.io/github/stars/chuanyedefeng/NewPush666?style=flat-square&logo=github&color=yellow)](https://github.com/chuanyedefeng/NewPush666/stargazers)
[![GitHub Forks](https://img.shields.io/github/forks/chuanyedefeng/NewPush666?style=flat-square&logo=github&color=blue)](https://github.com/chuanyedefeng/NewPush666/network/members)
[![License](https://img.shields.io/badge/license-GPL--3.0-blue.svg?style=flat-square)](LICENSE)
[![Version](https://img.shields.io/badge/version-v3.5.0-blue.svg)](https://github.com/chuanyedefeng/NewPush666)
[![MCP](https://img.shields.io/badge/MCP-v1.0.3-green.svg)](https://github.com/chuanyedefeng/NewPush666)
...
[![GitHub Actions](https://img.shields.io/badge/GitHub_Actions-自动化-2088FF?style=flat-square&logo=github-actions&logoColor=white)](https://github.com/chuanyedefeng/NewPush666)
[![GitHub Pages](https://img.shields.io/badge/GitHub_Pages-部署-4285F4?style=flat-square&logo=github&logoColor=white)](https://chuanyedefeng.github.io/NewPush666)
...
**👉 [点击查看最新文档](https://github.com/chuanyedefeng/NewPush666?tab=readme-ov-file)**

**如何判断？** 看页面顶部的仓库地址：
- `github.com/chuanyedefeng/NewPush666` ← 本项目地址
...
**💡 提示：** 想要**实时更新**的网页版？进入仓库 Settings → Pages，启用 GitHub Pages。[效果预览](https://chuanyedefeng.github.io/NewPush666/)。
...
>**升级说明**：
- **📌 查看最新更新**：**[更新日志](https://github.com/chuanyedefeng/NewPush666?tab=readme-ov-file#-更新日志)**
...
> **📖 提醒**：建议先 **[查看最新文档](https://github.com/chuanyedefeng/NewPush666?tab=readme-ov-file)**，确保配置步骤是最新的。
...
2. **设置 GitHub Secrets（选择你需要的平台）**:
   ...
   **设置步骤：**
   ...
   1. **查看生成的 URL**：
      ...
      - 格式如：`https://hooks.slack.com/services/YOUR_WORKSPACE/YOUR_CHANNEL/YOUR_TOKEN`
...
3. **手动测试新闻推送**：
   ...
   **如何找到你的 Actions 页面**：
   ...
   - **方法二**：直接访问 `https://github.com/chuanyedefeng/NewPush666/actions`
...
5. **🎉 部署成功！分享你的使用体验**
   ...
   恭喜你完成了 NewPush666 的配置！现在你可以开始追踪热点资讯了。
...
1. **创建项目目录和配置**:
   ...
   **方式 1-A：使用 git clone（推荐，最简单）**
   ```bash
   # 克隆项目到本地
   git clone https://github.com/chuanyedefeng/NewPush666.git
   cd NewPush666
   ```
   ...
   **方式 1-B：使用 wget 下载配置文件**
   ```bash
   # 创建目录结构
   mkdir -p newpush666/{config,docker}
   cd newpush666

   # 下载配置文件模板
   wget https://raw.githubusercontent.com/chuanyedefeng/NewPush666/master/config/config.yaml -P config/
   wget https://raw.githubusercontent.com/chuanyedefeng/NewPush666/master/config/frequency_words.txt -P config/
